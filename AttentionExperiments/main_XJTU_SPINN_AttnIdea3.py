...
from AttentionExperiments.ModelSPINN_AttnIdea3 import SPINN_AttnIdea3 as SPINN
import argparse
import os
import shutil
import math
        ...
        for e in range(10):
            ...
            architecture_args = {
                "solution_u_subnet_args": {
                    ...
                    # DO NOT add "attn_embed_dim" or "attn_heads" here!
                },
                ...
                # Instead, if you want to override attention dimension, you can just put them at top-level:
                "attn_embed_dim_u": 16,
                "attn_heads_u": 2,
                "attn_embed_dim_F": 16,
                "attn_heads_F": 2
