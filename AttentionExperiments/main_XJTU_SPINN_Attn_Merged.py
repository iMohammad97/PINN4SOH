...
from AttentionExperiments.ModelSPINN_AttnIdea_Merged import SPINN_Attn_Merged as SPINN
import argparse
import os
import shutil
import math
    ...
    for i in range(6):
        ...
        for e in range(10):
            ...
            architecture_args = {
                ...
                "attn_embed_dim_F": 16,
                "attn_heads_F": 2,
                # For the merged dynamical_F, specify how many tokens belong to group A:
                "dynamical_F_groupA_size": 5  # for instance; groupB will be total_dim - 3
            }
